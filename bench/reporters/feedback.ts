...
export function renderFeedbackReport(report: BenchmarkReport) {
  ...
  lines.push("Use `bench-results/latest.handoff.json` when you want a machine-friendly priority list.")
  lines.push("")
  ...
  lines.push(`- bench-results/latest.json`)
  lines.push(`- bench-results/latest.feedback.md`)
  lines.push(`- bench-results/latest.handoff.json`)
  lines.push("```")
  lines.push("")
