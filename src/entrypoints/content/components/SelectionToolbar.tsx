                ...
                <>
                  <button
                    ...
                    onClick={(event) => {
                      ...
                      recordLearningLoopEvent("result_feedback_submitted", { surface: "selection_toolbar", action: actionResult?.actionId ?? "unknown", signal: "helpful" })
                    }}
                  >
                  ...
                  <button
                    ...
                    onClick={(event) => {
                      ...
                      skipNextMouseUp.current = true
                      setFeedbackGiven(true)
                      recordLearningLoopEvent("result_feedback_submitted", { surface: "selection_toolbar", action: actionResult?.actionId ?? "unknown", signal: "inaccurate" })
                    }}
                  >
