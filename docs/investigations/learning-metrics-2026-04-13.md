...
A green `learning-loop` lane is **proof**, not automatic Gate 2 promotion.

Month 2 stays **proved but not gate-ready** until release policy / CI ownership explicitly promote the chained lane beyond optional status.
