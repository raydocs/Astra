...
1. reviewer and review date containing a real calendar `YYYY-MM-DD`, real target environment, stable run id, rubric version, and fixture manifest version;
