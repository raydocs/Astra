...
const FIXTURE_NAME = "nested-blocks"
const TARGET_LANG = "zh-CN"

export const pageTranslationNestedBlocksSourceScenario: LiveScenarioDefinition<LivePageTranslationExecution> = {
  id: "bench-live/page-translation-nested-blocks-source-bilingual",
  title: "Live page translation nested-blocks source bilingual",
  surface: "page-translation",
  fixture: `page:${FIXTURE_NAME}`,
  description:
    "Runs the real page-translation source module against the nested-blocks fixture, then opens the translated snapshot in a real browser for artifacts and scoring.",
  ...
  async run(runtime, context) {
    ...
    try {
      ...
      return {
        ...
        summary:
          "Executed the real page-translation source module on nested-blocks, then captured the translated result in a real browser.",
        notes: [
  ...
  async evaluate(execution, context) {
    return buildLivePageTranslationEvaluation(execution, context.runId, context.scenario, context.runtime, {
      successSummary: "Browser-backed nested-blocks source translation matched the existing page-translation benchmark contract.",
      failureSummary: "Browser-backed nested-blocks source translation diverged from the existing page-translation benchmark contract.",
    })
  },
}
