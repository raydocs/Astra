...
export const pageTranslationFormsAndNavSourceScenario: LiveScenarioDefinition<LivePageTranslationExecution> = {
  id: "bench-live/page-translation-forms-and-nav-source-bilingual",
  title: "Live page translation forms-and-nav source bilingual",
  surface: "page-translation",
  fixture: `page:${FIXTURE_NAME}`,
  description:
    "Runs the real page-translation source module against the forms-and-nav fixture, then opens the translated snapshot in a real browser for artifacts and scoring.",
  ...
  async run(runtime, context) {
    ...
    try {
      ...
      return {
        ...
        summary:
          "Executed the real page-translation source module on forms-and-nav, then captured the translated result in a real browser.",
        notes: [
  ...
  async evaluate(execution, context) {
    return buildLivePageTranslationEvaluation(execution, context.runId, context.scenario, context.runtime, {
      successSummary: "Browser-backed forms-and-nav source translation matched the existing page-translation benchmark contract.",
      failureSummary: "Browser-backed forms-and-nav source translation diverged from the existing page-translation benchmark contract.",
    })
  },
}
