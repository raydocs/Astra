...
function parseArgs(argv: string[]) {
  ...
  let baselineReportPath = path.resolve(process.cwd(), "bench-results/latest.json")
  let outputDir = path.resolve(process.cwd(), "bench-opt-results")
...
export function printBenchOptHelp() {
  ...
  console.log("  --baseline <file>       Existing bench artifact report (default: bench-results/latest.json)")
  console.log("  --output <dir>          Output directory for bench-opt artifacts (default: bench-opt-results)")
