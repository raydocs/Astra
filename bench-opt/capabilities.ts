...
export const astraV2Capabilities: readonly AstraCapabilityDefinition[] = [
  {
    ...
    currentCoverage: { bench: "green", live: "green", holdout: "partial", proof: "green" },
  ...
  },
  {
    ...
    currentCoverage: { bench: "green", live: "green", holdout: "green", proof: "missing" },
  ...
  },
  {
    ...
    beta: false,
    astraCurrentState: "partial",
    currentCoverage: { bench: "green", live: "green", holdout: "green", proof: "partial" },
  ...
  },
  {
    ...
    beta: true,
    astraCurrentState: "partial",
    currentCoverage: { bench: "partial", live: "missing", holdout: "missing", proof: "partial" },
    ...
    missingHarnessLanes: ["live", "holdout"],
    exitCriteria: [
  ...
  },
  {
    ...
    beta: false,
    astraCurrentState: "partial",
    currentCoverage: { bench: "green", live: "missing", holdout: "missing", proof: "partial" },
