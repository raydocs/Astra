...
export const pageTranslationArticleBasicSourceScenario: LiveScenarioDefinition<LivePageTranslationExecution> = {
  id: "bench-live/page-translation-article-basic-source-bilingual",
  title: "Live page translation article-basic source bilingual",
  surface: "page-translation",
  fixture: `page:${FIXTURE_NAME}`,
  description:
    "Runs the real page-translation source module against the article-basic fixture, then opens the translated snapshot in a real browser for artifacts and scoring.",
  ...
  async run(runtime, context) {
    ...
    try {
      ...
      return {
        ...
        summary:
          "Executed the real page-translation source module on article-basic, then captured the translated result in a real browser.",
        notes: [
  ...
  async evaluate(execution, context) {
    return buildLivePageTranslationEvaluation(execution, context.runId, context.scenario, context.runtime, {
      successSummary: "Browser-backed article-basic source translation matched the existing page-translation benchmark contract.",
      failureSummary: "Browser-backed article-basic source translation diverged from the existing page-translation benchmark contract.",
    })
  },
}
