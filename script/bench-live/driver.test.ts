...
describe("bench-live driver", () => {
  ...
  it("creates an artifact directory under a provided root", async () => {
    const artifactDir = await prepareLiveArtifactDir("driver-test-run", "data/bench-live-results-test")
    expect(artifactDir.endsWith("/data/bench-live-results-test/driver-test-run")).toBe(true)
  })
