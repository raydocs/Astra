 ...
 *
 * Usage:
 *   npx tsx script/bench-opt/contract-ab-entry.ts --prompt "Build X" --runs 3 --sprints 5
 *   npx tsx script/bench-opt/contract-ab-entry.ts --prompt "Build X" --runs 2 --sprints 3 --output-dir ./results
 */
...
function parseArgs(argv: string[]): ParsedArgs {
  ...
  let outputDir = path.resolve(
    process.env.ASTRA_BENCH_OPT_ARTIFACT_ROOT ?? path.join(process.cwd(), "data/bench-opt-results"),
    "contract-ab",
  )
...
function printHelp(): void {
  ...
  console.log("")
  console.log("Usage: npx tsx script/bench-opt/contract-ab-entry.ts [options]")
  console.log("")
  console.log("Options:")
  ...
  console.log(
    "  --output-dir, -o <path>    Output directory (default: data/bench-opt-results/contract-ab)",
  )
  console.log("  --help, -h                 Show this help message")
  console.log("")
  console.log("Examples:")
  console.log(
    '  npx tsx script/bench-opt/contract-ab-entry.ts --prompt "Build a todo app" --runs 3 --sprints 5',
  )
  console.log(
    '  npx tsx script/bench-opt/contract-ab-entry.ts -p "Translation extension" -r 2 -s 3',
  )
}
