...
export const astraV2Capabilities: readonly AstraCapabilityDefinition[] = [
  ...
  },
  {
    ...
    benchmarkSurfaces: ["input-translation", "subtitle", "subtitle-file", "pdf", "epub", "page-translation"],
    ...
    missingHarnessLanes: [],
    exitCriteria: [
      "Deterministic privacy assertions green across page, subtitle, local-file, and document-reader request payload surfaces.",
